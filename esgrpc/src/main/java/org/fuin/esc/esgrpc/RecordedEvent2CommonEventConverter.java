...
public final class RecordedEvent2CommonEventConverter implements Converter<RecordedEvent, CommonEvent> {
	...
	public final CommonEvent convert(final RecordedEvent eventData) {
		...
		final EscMeta escMeta = escMetaDeserializer.unmarshal(eventData.getUserMetadata(), escSerMetaType,
				escMetaMimeType);
	...
	private Object unmarshal(final String transferEncoding, final SerializedDataType dataType,
		...
		final Deserializer base64Deserializer = deserRegistry.getDeserializer(Base64Data.SER_TYPE, escMetaMimeType);
