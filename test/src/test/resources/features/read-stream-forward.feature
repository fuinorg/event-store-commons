...
Scenario: Append and read multiple
    Given the stream "append_multiple_stream" does not exist
    When I append the following events in the given order
    | Stream Name            | Expected Version   |  Event Id                             |
    | append_multiple_stream | NO_OR_EMPTY_STREAM |  26d53452-30a8-473b-b5cc-58650265dfb3 |
    | append_multiple_stream | 0                  |  6e4f3687-ccec-496b-8c22-c3848e6f2250 |
    | append_multiple_stream | 1                  |  2ce79b07-020c-4908-ad6f-cd63498d4c9f |
    | append_multiple_stream | 2                  |  cf27403b-f701-4288-9668-6173e9dbce71 |
    | append_multiple_stream | 3                  |  ce75244f-c3f6-44a0-a263-c94abf0ac480 |
    Then reading forward from stream should have the following results
    | Stream Name            | Start | Count | Result From  | Result Next | End Of Stream | Result Event Id 1                    | Result Event Id 2                    | Result Event Id 3                    |
    | append_multiple_stream | 0     | 3     | 0            | 3           | false         | 26d53452-30a8-473b-b5cc-58650265dfb3 | 6e4f3687-ccec-496b-8c22-c3848e6f2250 | 2ce79b07-020c-4908-ad6f-cd63498d4c9f |
    | append_multiple_stream | 3     | 3     | 3            | 5           | true          | cf27403b-f701-4288-9668-6173e9dbce71 | ce75244f-c3f6-44a0-a263-c94abf0ac480 | -                                    |
