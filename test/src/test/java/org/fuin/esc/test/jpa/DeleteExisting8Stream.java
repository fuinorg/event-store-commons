 ...
 * Contains stream.
 */
@Table(name = "DELETE_EXISTING_8_STREAMS")
@Entity
public class DeleteExisting8Stream extends JpaStream {
    ...
    public final JpaStreamEvent createEvent(@NotNull final JpaEvent eventEntry) {
        incVersion();
        return new DeleteExisting8Event(getVersion(), eventEntry);
    }
