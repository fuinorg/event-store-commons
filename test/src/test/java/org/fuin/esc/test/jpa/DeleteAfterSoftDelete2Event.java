 ...
 */
@Table(name = "DELETE_AFTER_SOFT_DELETE_2_EVENTS")
@Entity
public class DeleteAfterSoftDelete2Event extends JpaStreamEvent {
     ...
     */
    protected DeleteAfterSoftDelete2Event() {
        super();
    }
     ...
     */
    public DeleteAfterSoftDelete2Event(@NotNull final Integer version, final JpaEvent eventEntry) {
        super(eventEntry);
    ...
    public final boolean equals(final Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        DeleteAfterSoftDelete2Event other = (DeleteAfterSoftDelete2Event) obj;
        if (eventNumber == null) {
