 ...
 */
@Table(name = "DELETE_AFTER_HARD_DELETE_3_EVENTS")
@Entity
public class DeleteAfterHardDelete3Event extends JpaStreamEvent {
     ...
     */
    protected DeleteAfterHardDelete3Event() {
        super();
    }
     ...
     */
    public DeleteAfterHardDelete3Event(@NotNull final Integer version, final JpaEvent eventEntry) {
        super(eventEntry);
    ...
    public final boolean equals(final Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        DeleteAfterHardDelete3Event other = (DeleteAfterHardDelete3Event) obj;
        if (eventNumber == null) {
