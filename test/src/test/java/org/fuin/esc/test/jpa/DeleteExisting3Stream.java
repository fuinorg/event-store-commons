 ...
 * Contains stream.
 */
@Table(name = "DELETE_EXISTING_3_STREAMS")
@Entity
public class DeleteExisting3Stream extends JpaStream {
    ...
    public final JpaStreamEvent createEvent(@NotNull final JpaEvent eventEntry) {
        incVersion();
        return new DeleteExisting3Event(getVersion(), eventEntry);
    }
