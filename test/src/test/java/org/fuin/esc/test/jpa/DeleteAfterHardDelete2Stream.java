 ...
 * Contains stream.
 */
@Table(name = "DELETE_AFTER_HARD_DELETE_2_STREAMS")
@Entity
public class DeleteAfterHardDelete2Stream extends JpaStream {
     ...
     */
    public DeleteAfterHardDelete2Stream() {
        super();
        this.id = 1;
    }
    ...
    public final JpaStreamEvent createEvent(@NotNull final JpaEvent eventEntry) {
        incVersion();
        return new DeleteAfterHardDelete2Event(getVersion(), eventEntry);
    }
