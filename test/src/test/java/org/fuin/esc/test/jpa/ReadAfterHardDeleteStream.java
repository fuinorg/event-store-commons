 ...
 * Contains stream.
 */
@Table(name = "READ_AFTER_HARD_DELETE_STREAMS")
@Entity
public class ReadAfterHardDeleteStream extends JpaStream {
     ...
     */
    public ReadAfterHardDeleteStream() {
        super();
        this.id = 1;
    }
    ...
    public final JpaStreamEvent createEvent(@NotNull final JpaEvent eventEntry) {
        incVersion();
        return new ReadAfterHardDeleteEvent(getVersion(), eventEntry);
    }
