 ...
 */
@Table(name = "DELETE_EXISTING_4_EVENTS")
@Entity
public class DeleteExisting4Event extends JpaStreamEvent {
     ...
     */
    protected DeleteExisting4Event() {
        super();
    }
     ...
     */
    public DeleteExisting4Event(@NotNull final Integer version, final JpaEvent eventEntry) {
        super(eventEntry);
    ...
    public final boolean equals(final Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        DeleteExisting4Event other = (DeleteExisting4Event) obj;
        if (eventNumber == null) {
