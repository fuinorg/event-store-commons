...
public final class ReadBackwardCommand implements TestCommand {
     ...
     *            Expected events.
     */
    public ReadBackwardCommand(@NotNull final String streamName, final int start, final int count,
    ...
    public final void execute() {
        try {
            actualSlice = es.readEventsBackward(streamId, start, count);
    ...
    public final String toString() {
        return "ReadBackwardCommand [streamName=" + streamName + ", start=" + start + ", count=" + count
