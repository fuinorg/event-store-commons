 ...
 */
@Table(name = "DELETE_EXISTING_5_EVENTS")
@Entity
public class DeleteExisting5Event extends JpaStreamEvent {
     ...
     */
    protected DeleteExisting5Event() {
        super();
    }
     ...
     */
    public DeleteExisting5Event(@NotNull final Integer version, final JpaEvent eventEntry) {
        super(eventEntry);
    ...
    public final boolean equals(final Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        DeleteExisting5Event other = (DeleteExisting5Event) obj;
        if (eventNumber == null) {
