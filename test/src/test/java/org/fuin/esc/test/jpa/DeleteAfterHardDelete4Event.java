 ...
 */
@Table(name = "DELETE_AFTER_HARD_DELETE_4_EVENTS")
@Entity
public class DeleteAfterHardDelete4Event extends JpaStreamEvent {
     ...
     */
    protected DeleteAfterHardDelete4Event() {
        super();
    }
     ...
     */
    public DeleteAfterHardDelete4Event(@NotNull final Integer version, final JpaEvent eventEntry) {
        super(eventEntry);
    ...
    public final boolean equals(final Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        DeleteAfterHardDelete4Event other = (DeleteAfterHardDelete4Event) obj;
        if (eventNumber == null) {
