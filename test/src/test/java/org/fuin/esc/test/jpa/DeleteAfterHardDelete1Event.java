 ...
 */
@Table(name = "DELETE_AFTER_HARD_DELETE_1_EVENTS")
@Entity
public class DeleteAfterHardDelete1Event extends JpaStreamEvent {
     ...
     */
    protected DeleteAfterHardDelete1Event() {
        super();
    }
     ...
     */
    public DeleteAfterHardDelete1Event(@NotNull final Integer version, final JpaEvent eventEntry) {
        super(eventEntry);
    ...
    public final boolean equals(final Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        DeleteAfterHardDelete1Event other = (DeleteAfterHardDelete1Event) obj;
        if (eventNumber == null) {
