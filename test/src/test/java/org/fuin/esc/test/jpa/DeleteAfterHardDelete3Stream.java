 ...
 * Contains stream.
 */
@Table(name = "DELETE_AFTER_HARD_DELETE_3_STREAMS")
@Entity
public class DeleteAfterHardDelete3Stream extends JpaStream {
     ...
     */
    public DeleteAfterHardDelete3Stream() {
        super();
        this.id = 1;
    }
    ...
    public final JpaStreamEvent createEvent(@NotNull final JpaEvent eventEntry) {
        incVersion();
        return new DeleteAfterHardDelete3Event(getVersion(), eventEntry);
    }
