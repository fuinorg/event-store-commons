 ...
 */
@Table(name = "DELETE_EXISTING_7_EVENTS")
@Entity
public class DeleteExisting7Event extends JpaStreamEvent {
     ...
     */
    protected DeleteExisting7Event() {
        super();
    }
     ...
     */
    public DeleteExisting7Event(@NotNull final Integer version, final JpaEvent eventEntry) {
        super(eventEntry);
    ...
    public final boolean equals(final Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        DeleteExisting7Event other = (DeleteExisting7Event) obj;
        if (eventNumber == null) {
