 ...
 */
@Table(name = "DELETE_EXISTING_1_EVENTS")
@Entity
public class DeleteExisting1Event extends JpaStreamEvent {
     ...
     */
    protected DeleteExisting1Event() {
        super();
    }
     ...
     */
    public DeleteExisting1Event(@NotNull final Integer version, final JpaEvent eventEntry) {
        super(eventEntry);
    ...
    public final boolean equals(final Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        DeleteExisting1Event other = (DeleteExisting1Event) obj;
        if (eventNumber == null) {
