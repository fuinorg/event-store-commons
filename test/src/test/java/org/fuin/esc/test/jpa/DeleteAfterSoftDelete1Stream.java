 ...
 * Contains stream.
 */
@Table(name = "DELETE_AFTER_SOFT_DELETE_1_STREAMS")
@Entity
public class DeleteAfterSoftDelete1Stream extends JpaStream {
     ...
     */
    public DeleteAfterSoftDelete1Stream() {
        super();
        this.id = 1;
    }
    ...
    public final JpaStreamEvent createEvent(@NotNull final JpaEvent eventEntry) {
        incVersion();
        return new DeleteAfterSoftDelete1Event(getVersion(), eventEntry);
    }
