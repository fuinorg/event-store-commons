 ...
 */
@Table(name = "DELETE_AFTER_SOFT_DELETE_4_EVENTS")
@Entity
public class DeleteAfterSoftDelete4Event extends JpaStreamEvent {
     ...
     */
    protected DeleteAfterSoftDelete4Event() {
        super();
    }
     ...
     */
    public DeleteAfterSoftDelete4Event(@NotNull final Integer version, final JpaEvent eventEntry) {
        super(eventEntry);
    ...
    public final boolean equals(final Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        DeleteAfterSoftDelete4Event other = (DeleteAfterSoftDelete4Event) obj;
        if (eventNumber == null) {
