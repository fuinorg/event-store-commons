 ...
 */
@Table(name = "DELETE_AFTER_SOFT_DELETE_1_EVENTS")
@Entity
public class DeleteAfterSoftDelete1Event extends JpaStreamEvent {
     ...
     */
    protected DeleteAfterSoftDelete1Event() {
        super();
    }
     ...
     */
    public DeleteAfterSoftDelete1Event(@NotNull final Integer version, final JpaEvent eventEntry) {
        super(eventEntry);
    ...
    public final boolean equals(final Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        DeleteAfterSoftDelete1Event other = (DeleteAfterSoftDelete1Event) obj;
        if (eventNumber == null) {
