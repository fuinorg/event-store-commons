 ...
 */
@Table(name = "READ_AFTER_SOFT_DELETE_EVENTS")
@Entity
public class ReadAfterSoftDeleteEvent extends JpaStreamEvent {
     ...
     */
    protected ReadAfterSoftDeleteEvent() {
        super();
    }
     ...
     */
    public ReadAfterSoftDeleteEvent(@NotNull final Integer version, final JpaEvent eventEntry) {
        super(eventEntry);
    ...
    public final boolean equals(final Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        ReadAfterSoftDeleteEvent other = (ReadAfterSoftDeleteEvent) obj;
        if (eventNumber == null) {
