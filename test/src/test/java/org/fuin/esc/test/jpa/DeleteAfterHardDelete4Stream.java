 ...
 * Contains stream.
 */
@Table(name = "DELETE_AFTER_HARD_DELETE_4_STREAMS")
@Entity
public class DeleteAfterHardDelete4Stream extends JpaStream {
     ...
     */
    public DeleteAfterHardDelete4Stream() {
        super();
        this.id = 1;
    }
    ...
    public final JpaStreamEvent createEvent(@NotNull final JpaEvent eventEntry) {
        incVersion();
        return new DeleteAfterHardDelete4Event(getVersion(), eventEntry);
    }
