 ...
 * Contains stream.
 */
@Table(name = "DELETE_EXISTING_5_STREAMS")
@Entity
public class DeleteExisting5Stream extends JpaStream {
    ...
    public final JpaStreamEvent createEvent(@NotNull final JpaEvent eventEntry) {
        incVersion();
        return new DeleteExisting5Event(getVersion(), eventEntry);
    }
