 ...
 * Contains stream.
 */
@Table(name = "DELETE_AFTER_HARD_DELETE_1_STREAMS")
@Entity
public class DeleteAfterHardDelete1Stream extends JpaStream {
     ...
     */
    public DeleteAfterHardDelete1Stream() {
        super();
        this.id = 1;
    }
    ...
    public final JpaStreamEvent createEvent(@NotNull final JpaEvent eventEntry) {
        incVersion();
        return new DeleteAfterHardDelete1Event(getVersion(), eventEntry);
    }
