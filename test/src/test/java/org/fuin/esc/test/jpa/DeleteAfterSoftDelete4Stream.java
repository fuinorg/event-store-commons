 ...
 * Contains stream.
 */
@Table(name = "DELETE_AFTER_SOFT_DELETE_4_STREAMS")
@Entity
public class DeleteAfterSoftDelete4Stream extends JpaStream {
     ...
     */
    public DeleteAfterSoftDelete4Stream() {
        super();
        this.id = 1;
    }
    ...
    public final JpaStreamEvent createEvent(@NotNull final JpaEvent eventEntry) {
        incVersion();
        return new DeleteAfterSoftDelete4Event(getVersion(), eventEntry);
    }
