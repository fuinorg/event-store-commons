...
@Entity
public class AppendSingleAgainEvent extends JpaStreamEvent {
     ...
     */
    protected AppendSingleAgainEvent() {
        super();
    }
     ...
     */
    public AppendSingleAgainEvent(@NotNull final Integer version, final JpaEvent eventEntry) {
        super(eventEntry);
    ...
    public final boolean equals(final Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        AppendSingleAgainEvent other = (AppendSingleAgainEvent) obj;
        if (eventNumber == null) {
