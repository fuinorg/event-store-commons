 ...
 */
@Table(name = "DELETE_EXISTING_2_EVENTS")
@Entity
public class DeleteExisting2Event extends JpaStreamEvent {
     ...
     */
    protected DeleteExisting2Event() {
        super();
    }
     ...
     */
    public DeleteExisting2Event(@NotNull final Integer version, final JpaEvent eventEntry) {
        super(eventEntry);
    ...
    public final boolean equals(final Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        DeleteExisting2Event other = (DeleteExisting2Event) obj;
        if (eventNumber == null) {
