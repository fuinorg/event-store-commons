 ...
 */
public final class AppendToStreamHandler extends AbstractCompletedHandler {
     ...
     *            Expected version.
     */
    public AppendToStreamHandler(@NotNull final StreamId streamId,
    ...
    public final WriteEventsCompleted getResult()
        ...
        if (getException() != null) {
            ...
            final WriteEventsCompleted completed = (WriteEventsCompleted) getMessage();
