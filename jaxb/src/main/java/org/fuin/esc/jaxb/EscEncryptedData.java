...
/**
 * JAXB representation of {@link EncryptedData}. It wraps the encrypted bytes of an event together with the information needed to decrypt
 * it again (key identifier, key version, original data type and content type). Equals and hash code are based on all data.
 */
@ImmutableAfterUnmarshal
@HasSerializedDataTypeConstant
@XmlRootElement(name = EscEncryptedData.EL_ROOT_NAME)
...
public final class EscEncryptedData implements EncryptedData, IBaseType {
    ...
    /**
     * Default constructor for deserialization (JAXB).
     */
