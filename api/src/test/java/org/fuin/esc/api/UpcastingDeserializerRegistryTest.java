...
/**
 * Tests the {@link UpcastingDeserializerRegistry} class.
 */
public class UpcastingDeserializerRegistryTest {
    ...
    @Test
    public void testGetDeserializerUpcastsToLatest() {
        ...
        // TEST
        final Object result = upcasting.getDeserializer(TYPE, mimeV1)
                .unmarshal("raw".getBytes(StandardCharsets.UTF_8), TYPE, mimeV1);
    ...
    @Test
    public void testLatestVersionUnchanged() {

        // PREPARE: a v2 deserializer, converter only registered for v1
        ...
        // TEST
        final Object result = upcasting.getDeserializer(TYPE, mimeV2)
                .unmarshal("raw".getBytes(StandardCharsets.UTF_8), TYPE, mimeV2);
    ...
    @Test
    public void testDelegatesLookupMethods() {
        ...
        // TEST & VERIFY
        assertThat(upcasting.deserializerExists(TYPE, mimeV1)).isTrue();
        assertThat(upcasting.deserializerExists(new SerializedDataType("Other"), mimeV1)).isFalse();
        assertThat(upcasting.getDefaultMimeType()).isEqualTo(DEFAULT_MIME_TYPE);
