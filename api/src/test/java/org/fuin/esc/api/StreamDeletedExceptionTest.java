...
/**
 * Tests the {@link StreamDeletedException} class.
 */
// CHECKSTYLE:OFF Test
public class StreamDeletedExceptionTest {

    private static final StreamId STREAM_ID = new SimpleStreamId("MyStream");

    private StreamDeletedException testee;

    @BeforeEach
    public void setup() {
        testee = new StreamDeletedException(STREAM_ID);
    }
    ...
    public void testSerializeDeserialize() {
        ...
        // PREPARE
        final StreamDeletedException original = testee;

        // TEST
        final byte[] data = serialize(original);
        final StreamDeletedException copy = deserialize(data);
