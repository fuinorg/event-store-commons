...
/**
 * Creates Jackson {@link EscEncryptedData} instances for use with the {@link org.fuin.esc.crypto.EncryptingEventStore}.
 */
public final class EscEncryptedDataFactory implements EncryptedDataFactory {

    @Override
    public SerializedDataType getType() {
        return EscEncryptedData.SER_TYPE;
    }

    @Override
    public EncryptedData create(final EncryptedData encryptedData) {
        return new EscEncryptedData(encryptedData);
    }
