...
public class ESHttpEventStoreSyncTest {
    ...
    public void setup() throws MalformedURLException {
        ...
        final SerializedDataType serMetaType = new SerializedDataType(MyMeta.TYPE);
        ...
        registry.add(new SerializedDataType(MyMeta.TYPE), "application/xml", xmlDeSer);

        testee = new ESHttpEventStoreSync(threadFactory, url, serMetaType, ESEnvelopeType.XML, registry,
                registry);
        testee.open();
    }
    ...
    public void testReadEventsBackward() {
        ...
        // VERIFY Slice 1
        assertThat(slice1.getEvents()).containsExactly(eventFour, eventFive);
        ...
        // VERIFY Slice 2
        assertThat(slice2.getEvents()).containsExactly(eventTwo, eventThree);
